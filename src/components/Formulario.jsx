...
const Formulario = ({pacientes, setPacientes,paciente,setPaciente}) => {
  ...
  const [sintomas,setSistomas] = useState('');
  ...
  return (
    <div className='md:w-1/2 lg:w-2/5'>
      ...
      <form onSubmit={ handleSubmit } className='bg-white shadow-md rounded-lg py-10 px-5 mb-10'>
        { error && <Error mensaje='Todos los campos son requiredo' /> }
        <div className='mb-5'>
        ...
        <div className='mb-5'>
          ...
          <textarea 
              ...
              value={sintomas}
              onChange={ (e) => setSistomas(e.target.value) }
          />
        </div>
